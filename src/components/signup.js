...
onSubmit(e) {
    ...
    console.log(obj);
    axios.post('http://192.168.31.238:8080/api/v1/users/register', obj)
        .then(response => { 
  ...
  // Regex for Input Validation
    ...
    return(
        ...
        <div>
          ...
          <h1 className="h3 mb-3 font-weight-normal"> <Icon.PersonPlusFill/>Register</h1>
          <div className="row">
            ...
            <div className="col">
              ...
              {this.state.username && (
              <span>
                  <small className ={hasUsername?"text-success":"text-danger"}>
                    Username should be at least 6 characters </small>
                 </span>
                 )}
              <input
                type="text"
        ...
        className="submit"
        disabled ={
        !hasSixChar||!hasNumber||!hasLowerChar||!hasUpperChar||!hasUsername||!hasSpecialChar||!this.state.firstname||!this.state.lastname||!Pass} 
