...
onSubmit2(e) {
  e.preventDefault();
   ...
   console.log(obj2);
   axios.post('http://192.168.31.238:8080/api/v1/sensordata/submit',obj2)
...
onSubmit(e) {
   e.preventDefault();
    ...
    axios.post('http://192.168.31.238:8080/api/v1/vehicles/register', obj)
  ...
  <div class="card">
    <div class="card-header" id="headingTwo">
      <h1 class="mb-0">
       ...
       <h4><Icon.PlusCircleFill/> Fahrzeug ID Hinzufügen <Icon.Truck/> </h4>
        </button>
      </h1>
    </div>
...
<div className="row">
  <div className="col">
    <input
      ...
      placeholder="Fahrzeug Id:W0L000051T2123456" required 
  ...
  <div class="card">
    <div class="card-header" id="headingThree">
      <h5 class="mb-0">
        ...
        <h4><Icon.PlusCircleFill/> Fahrzeug-Information Hinzufügen  <Icon.Truck/> </h4>
        </button>
      </h5>
    </div>
...
<input
      type="text"
      value={this.state.value}
      placeholder="Enter value DBL:2,4" required 
...
<input
      ...
      placeholder="Enter Timestamps:1637865783" required 
...
<div id="accordion">
  ...
  <div class="card-header" id="headingFour">
        ...
        <button class="btn btn-link" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
         <h4> <Icon.InfoCircle />Fahrzeug-Informationen </h4>
        </button>
      </h1>
    </div>
